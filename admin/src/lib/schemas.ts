...
export const SCHEMAS: SchemaContenu[] = [
  ...
  {
    cle: "versets_du_jour",
    table: "versets_du_jour",
    libelle: "Verset du jour",
    librelleSingulier: "verset",
    description: "Verset biblique diffusé chaque jour sur l'accueil de l'application.",
    icone: "📖",
    groupe: "Spiritualité",
    colonneTri: "date",
    triDescendant: true,
    colonnes: [
      ...
      { nom: "traduction", libelle: "Traduction" },
    ],
    champs: [
      { nom: "date", libelle: "Date", type: "date", requis: true, aide: "Un seul verset par date — un nouveau chaque jour." },
      { nom: "reference", libelle: "Référence", type: "texte", requis: true, aide: "Ex. : Philippiens 4:13" },
      { nom: "texte", libelle: "Texte du verset", type: "texte_long", requis: true, pleineLargeur: true },
      { nom: "traduction", libelle: "Traduction", type: "texte", defaut: "Louis Segond" },
      { nom: "meditation", libelle: "Méditation", type: "texte_long", pleineLargeur: true },
    ],
  },
  {
